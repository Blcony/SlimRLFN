...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_id", default=21, type=int)
    parser.add_argument("--use_prune", action="store_true", help="select model after pruning")
    parser.add_argument('--use_repeat', action="store_true", help="repeat 5 times")
